...
<div class="row">
  ...
  <div class="col-md-6">
  <form class="text-center border-light" method="post" action="{{url('Add_Market')}}">
    @csrf
 ...
 <div class="form-group">
   <label for="productname">Market Name</label>
   <input class="form-control" name="marketname" type="text">
 </div>
    
   
<div class="form-group">
 
<label class="control-label">Market Image</label>
 
<input class="filestyle"name="marketimage" data-icon="false" type="file">
 
</div>
    
    <div class="form-group">
      <label class="loginformelement" for="productdescription">Market Location</label>
  	  <input name="marketlocation" class="form-control input-lg"type="text"><div class="container">
      </div>
 
    <button style="background-color:#2196f3 !important;" class="btn btn-info my-4 rounded-pill"type="submit" name="marketSubmit">Add Market</button>
