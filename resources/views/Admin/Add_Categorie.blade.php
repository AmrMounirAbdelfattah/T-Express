...
<div class="row">
  ...
  <div class="col-md-6">
  <form class="text-center border-light" method="post" action="{{url('Add_Categorie')}}">
    @csrf
  

  <select class="form-control form-group" name="marketSelect"><option>Please Select a Categorie Market</option>
      <option value="0">Choose option</option>
      <option value="1">Carrefour</option>
      <option value="2">Fathalla Market</option>
      
    </select>
         
 <div class="form-group">
   <label for="productname">Categorie Name</label>
   <input class="form-control" name="Categoriename" type="text">
 </div>
...
<label class="control-label">Categorie Image</label>
 
<input class="filestyle" name="Categorieimage" data-icon="false" type="file">
 
</div>
    
    
 
    <button style="background-color:#2196f3 !important;" class="btn btn-info my-4 rounded-pill"type="submit" name="CategorieSubmit">Add Categorie</button>
