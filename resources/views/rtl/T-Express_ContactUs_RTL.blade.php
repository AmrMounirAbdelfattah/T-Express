...
<!--Start body-->
    ...
    <!--Start Contact Us-->
      ...
      <form class="text-center border-light" method="post" action="{{url('T-Express_ContactUs_RTL')}}">
                        @csrf
                ...
                <!-- Name -->
                <input type="text" name="name" class="form-control mb-4" placeholder="الاسم">

                <!-- Email -->
                <input type="email" name="email" class="form-control mb-4" placeholder="الإيميل">
                ...
                <div class="form-group">
                    <textarea class="form-control rounded-0" name="message" rows="3" placeholder="الرسالة"></textarea>
                </div>
